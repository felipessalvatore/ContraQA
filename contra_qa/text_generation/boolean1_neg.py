...
def boolean1():
    ...
    all_sentences_1 = ["{} is {}, {} is not {}".format(
        car, cdr, car, cdr) for car, cdr in template1]
    ...
    all_sentences_2 = ["{} is not {}, {} is {}".format(
        car, cdr, car, cdr) for car, cdr in template2]
    all_sentences_2 = [sentence.split(",") + [1]
                       for sentence in all_sentences_2]
    np.random.shuffle(all_sentences_2)

    template3 = itertools.product(
        name_list, positive_personality_list, condition_list)
    ...
    all_sentences_4 = ["{} is {}, {} is not {}".format(
        car, cdr, car, cddr) for car, cdr, cddr in template3]
    ...
    all_sentences_5 = ["{} is not {}, {} is {}".format(
        car, cdr, car, cddr) for car, cdr, cddr in template3]

    all_sentences_5 = [sentence.split(",") + [0]
    ...
    for triple in template6:
        ...
        car, cdr, cddr = triple
        all_sentences_6.append(
            "{} is {}, {} is {}".format(car, cdr, new_name, cddr))
    ...
    for triple in template7:
        ...
        while new_name == triple[0]:
            ...
            new_name = name_list[i]
        car, cdr, cddr = triple
        all_sentences_7.append(
            "{} is {}, {} is not {}".format(car, cdr, new_name, cddr))
    ...
    for triple in template8:
        ...
        while new_name == triple[0]:
            ...
            new_name = name_list[i]
        car, cdr, cddr = triple
        all_sentences_8.append(
            "{} is not {}, {} is {}".format(car, cdr, new_name, cddr))
    ...
    for car, cdr in template9:
        ...
        while new_name == car:
            i = np.random.choice(len(name_list))
            new_name = name_list[i]
        all_sentences_9.append(
            "{} is {}, {} is not {}".format(car, cdr, new_name, cdr))

    all_sentences_9 = [sentence.split(",") + [0]
                       for sentence in all_sentences_9]
    ...
    for car, cdr in template10:
        ...
        while new_name == car:
            i = np.random.choice(len(name_list))
            new_name = name_list[i]
        all_sentences_10.append(
            "{} is not {}, {} is {}".format(car, cdr, new_name, cdr))

    all_sentences_10 = [sentence.split(",") + [0]
                        for sentence in all_sentences_10]
    ...
    all_sentences = all_sentences_1 + all_sentences_2 + \
        all_sentences_3 + all_sentences_4 + all_sentences_5
    all_sentences = all_sentences + all_sentences_6 + all_sentences_7 + \
        all_sentences_8 + all_sentences_9 + all_sentences_10
