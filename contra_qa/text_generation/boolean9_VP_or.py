...
try:
    from word_lists import name_list, professions, color_list, city_list
except ImportError:
    from contra_qa.text_generation.word_lists import name_list, professions, color_list, city_list  # noqa
